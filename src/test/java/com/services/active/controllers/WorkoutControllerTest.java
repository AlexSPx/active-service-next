...
class WorkoutControllerTest extends IntegrationTestBase {
    ...
    void createWorkout_missingTemplate_badRequest(@TestUserToken String token) throws Exception {
    ...
    void createWorkout_success_withTemplate(@TestUserToken String token) throws Exception {
